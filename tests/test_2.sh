...
goal app call \
    --app-id 19 \
    -f JK4ATA2L6F7VF5JZZBYSJCHJLMEZ46PFW2A4IJXBFS5BTTVLAKSSPXRKAI \
    --app-account B3YN436PGAA2WPZ3K5Y67S7VRPT2GRYDMBFZI6GXL4Z4SDHTBOV5XOFZJA \
    --app-arg "str:accept" \
    --app-arg "str:scissors" \
    -o play-start.tx

goal clerk send \
    -a 100000 \
    -t IENLVNK7TDN6X3W26JGMRDT2RKKNX7CYVRGJTTUV34O54NXHNQ3C7DA5TA \
    -f JK4ATA2L6F7VF5JZZBYSJCHJLMEZ46PFW2A4IJXBFS5BTTVLAKSSPXRKAI \
    -o play-wager.tx
